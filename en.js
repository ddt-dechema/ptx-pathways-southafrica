var translations_en = {
  ...
  filter_text: `A distinction is made between industrial and biogenic carbon sources. Industrial sources are the largest contributors to carbon emissions in South Africa, due to their reliance on fossil-based feedstocks and energy-intensive production processes. Within this, the energy sector is the primary contributor, with coal-fired power stations responsible for approximately 70% of the country’s total CO<sub>2</sub> industrial emissions. Other significant sources include the petrochemical industry, which generates emissions through the production of synthetic fuels and various chemical products such as ammonia, methanol, and ethylene, among others. In addition, the metal industry, which includes steel, ferroalloy, and aluminum production, along with the cement sector, also plays a substantial role in South Africa’s industrial carbon emissions.<br>
  <br>Biogenic carbon emissions in South Africa arise from industrial activities using biomass as a power source or feedstock. Notable examples include the pulp and paper industry and the sugar industry, where the potential for biogenic carbon accounts for 70-80% and 80-90% of their emissions, respectively. Additionally, purely biogenic emissions result from activities such as bioethanol production, as well as biogas and biomass power plants.<br>
