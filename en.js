var translations_en = {
  ...
  filter_text_introduction: `This map shows industrial (non-biogenic) <span class="rect dot_industrial"></span> and biogenic point sources of carbon <span class="rect dot_biogenic"></span> in the form of emitted CO<sub>2</sub>. You can click on the different buttons to toggle the visibility of the respective sources on the map. Additionally, you can manually select or deselect specific plant types.`,
...
The largest volumes of the IAPs accessible for forestry machinery, in areas with slopes below 35%, are located in KwaZulu-Natal, Eastern Cape and Limpopo provinces [1].`,
 ...
 According to the State of Waste Report [4], organic waste – mainly garden, food and wood waste – made up 56% of South Africa’s general waste in 2017. While wood waste is often reused or recycled by industries such as sugar, pulp and paper, and forestry, garden and food waste still largely end up in landfills. Diverting these waste streams could create significant value in PtX processes and beyond, for example for biogas production through anaerobic digestion or for composting. Around 3500-7400 kilotonnes of biogenic CO<sub>2</sub> per year could be captured from these sources. 
...
The regional distribution of this type of biomass is expected to mirror volumes of the formally treated wastewater, with Gauteng accounting for nearly a half of the total volume [4].`,
  biogenic_ELT: `<br><h4>End-of-life tyres (ELT)</h4>Natural rubber, a key component of tyres, can also be considered as another source of biogenic carbon. Management ELTs remains a challenge in South Africa, with most not yet recycled, leading to overfull depots and landfill accumulation [5]. Illegal dumping or improper use for energy purposes further poses significant environmental and health risks [6]. Coordinated utilisation could therefore help address both carbon sourcing for PtX processes and tyre waste management, yielding potentially around 180-260 kilotonnes of biogenic CO<sub>2</sub> per year. This value assumes that 90% of the accumulated backlog of 900 kilotonnes can be utilised until 2038, as well as 100% conversion of all new passenger cars and truck ELTs (250-300 kilotonnes per year) [5].
In 2023, Gauteng accounted for nearly one-third of the total quantity of waste tyres stored in depots in South Africa [5].`,
biogenic_forestry: `<br><h4>Forestry residues</h4>While hardwood is largely processed in the pulp and board industry - with related point emissions shown on the map – softwood is processed in sawmills, which often have low recovery rates, and therefore, significant waste production. These residues are currently used for low-efficiency electricity generation [7], resulting in local CO₂ emissions. The amount of carbon available from forestry residues is significantly lower than from other sources, with an estimated value of 3 kilotonnes CO<sub>2</sub> per year. If collected centrally, forestry residues still could serve as a carbon source for PtX processes. In this case, renewable electricity alternatives for local communities and facilities need to be secured. 
