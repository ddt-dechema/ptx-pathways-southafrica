var translations_en = {
  ...
  CO<sub>2</sub>, a greenhouse gas often produced as an industrial byproduct, is currently released into the atmosphere at most production sites. However, it has significant potential as a raw material for carbon-based Power-to-X (PtX) products, such as e-methanol and synthetic fuels (e-fuels). The competitiveness of these products depends largely on the availability and quality of the CO<sub>2</sub> supply, making it essential to identify reliable sources. This map showcases major CO<sub>2</sub> emitters across South Africa, providing essential data on the location, type, and scale of key industrial point sources to support PtX project development in the country.
    This map aims to identify carbon sources (in the form of CO<sub>2</sub>) in South Africa to collaborate in the search for opportunities to develop PtX projects in the country. 
    <br>This tool offers a comprehensive overview of carbon sources in South Africa, with CO<sub>2</sub> mainly derived from industrial point emissions. It should be nevertheless noted that in the long term, the carbon needed for PtX applications should stem from a non-fossil, closed carbon cycle, to ensure carbon neutrality. Direct Air Capture (DAC) and biogenic point sources could meet this requirement, provided that sustainability criteria are taken into account.`,
